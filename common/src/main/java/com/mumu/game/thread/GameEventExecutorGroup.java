...
public class GameEventExecutorGroup extends AbstractEventExecutorGroup {
     ...
     *
     */
    protected EventExecutor newChild(ThreadFactory threadFactory, int maxPendingTasks,
    ...
    /**
     * Return the number of {@link EventExecutor} this implementation uses. This number is the maps 1:1 to the threads
     * it use.
     */
