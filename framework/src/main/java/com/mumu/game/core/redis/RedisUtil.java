...
package com.mumu.game.core.redis;
...
import com.mumu.game.core.redis.constants.RedisLuaScript;
...
public class RedisUtil {
    ...
    public static long zIncr(String key, long id, long score, boolean removeNegative) {
        ...
        // id,
        // score);
        return RedisLuaScript.ZSCORE_UPDATE_BY_TIME.executeLua(List.of(key, String.valueOf(id), String.valueOf(score),
    ...
    public static Map<Long, ScoreInfo> getTopNMap(String key, int rank) {
        ...
        int r = 1;
        for (ZSetOperations.TypedTuple<String> next : getTopN(key, rank)) {
