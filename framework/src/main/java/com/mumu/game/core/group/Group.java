package com.mumu.game.core.group;

import java.util.Set;

/**
 * Group
 * 组，适用于需要将特定的一些人圈在一个范围里面 这里面的人一个人产生了一个消息，一般需要组里面的人都知晓
 * @author liuzhen
...
public interface Group {
     ...
     * @since 2024/11/4 17:51
     */
    Set<Long> getPlayerIdSet();

    /**
     * 清除租中所有玩家
     * @since 2024/11/4 17:54
     */
    void clear();
}
