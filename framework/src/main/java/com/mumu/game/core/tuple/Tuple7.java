package com.mumu.game.core.tuple;

import java.io.Serial;
import java.io.Serializable;

/**
 * Tuple7 是一个包含7个对象的简单对象 一般用于一个函数需要返回7个值时方便使用,或者需要把一些7个对象组合的内容放入容器时使用
 * @author liuzhen
 * @version 1.0.0 2024/11/6 13:56
 */
public class Tuple7<T1, T2, T3, T4, T5, T6, T7> implements Serializable {
   ...
   * 构造函数
   */
  public Tuple7(T1 _1_, T2 _2_, T3 _3_, T4 _4_, T5 _5_, T6 _6_, T7 _7_) {
    this._1 = _1_;
    this._2 = _2_;
    this._3 = _3_;
    this._4 = _4_;
  ...
  public String toString() {
    return "[1=" + _1 + ", 2=" + _2 + ", 3=" + _3 + ", 4=" + _4 + ", 5=" + _5 + ", 6=" + _6 + ", 7="
        + _7 + "]";
  }
}
