package com.mumu.game.core.redis.manager;
...
import com.mumu.game.core.redis.constants.RedisConstants;
    ...
    public static void expire(String key, long expireSecond, BiConsumer<String, Long> consumer) {
        ...
        if (null == res) {
            try {
                ...
                LogTopic.ACTION.error(e, "RedisExpireManager-expire", "key", key, "expireAtTime", expireSecond);
            }
        }
    }
    ...
    public static void expireAt(String key, long expireAtTime, BiConsumer<String, Long> consumer) {
        ...
        if (null == res || res != expireAtTime) {
            try {
                ...
                LogTopic.ACTION.error(e, "RedisExpireManager-expireAt", "key", key, "expireAtTime", expireAtTime);
            }
        }
    }
}
