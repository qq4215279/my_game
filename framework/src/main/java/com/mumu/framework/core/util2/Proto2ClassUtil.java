...
/**
 * Proto2ClassUtil proto 协议生成java代码工具类
 * 
 * @author liuzhen
...
public class Proto2ClassUtil {
    ...
    public static void main(String[] args) {
        ...
        List<File> txtFiles = FileUtil.loopFiles(protoAbPath, file -> file.getName().endsWith(".proto"));
